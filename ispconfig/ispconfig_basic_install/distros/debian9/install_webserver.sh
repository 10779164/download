...
InstallWebServer() {
  ...
  if [ $CFG_PHP56 == "yes" ]; then
	...
	apt-get -yqq install php5.6 php5.6-common php5.6-gd php5.6-mysql php5.6-imap php5.6-cli php5.6-cgi php5.6-mcrypt php5.6-curl php5.6-intl php5.6-pspell php5.6-recode php5.6-sqlite3 php5.6-tidy php5.6-xmlrpc php5.6-xsl php5.6-zip php5.6-mbstring php5.6-fpm > /dev/null 2>&1
  ...
  CFG_APACHE=n
	...
	apt-get -yqq install fcgiwrap > /dev/null 2>&1
