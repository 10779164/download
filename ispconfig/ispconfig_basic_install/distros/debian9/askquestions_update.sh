AskQuestions_update() {
	...
	CFG_SERVICE=$(whiptail --title "update ispconfig" --backtitle "$WT_BACKTITLE" --nocancel --radiolist "Select you want update server" 10 50 3 "MAIL" "" ON "DNS" "" OFF "MAIL and DNS" "" OFF 3>&1 1>&2 2>&3)
